...
export const authAPI = {
  ...
  getAllUsers: (): Promise<AxiosResponse<{ data: any[] }>> =>
...
export const profileAPI = {
  ...
  requestEdit: (data: any): Promise<AxiosResponse<any>> =>
    api.post('/profile/edit-request', data),
  updateProfile: (data: Partial<Profile>): Promise<AxiosResponse<any>> =>
  ...
  getPendingRequests: (): Promise<AxiosResponse<any[]>> =>
    api.get('/profile/admin/pending'),
  approveRequest: (
    ticketId: string,
    status: 'APPROVED' | 'REJECTED',
    adminNote?: string,
  ) => api.post(`/profile/admin/approve/${ticketId}`, { status, adminNote }),
  getAllStudents: (): Promise<AxiosResponse<{ data: any[] }>> =>
    api.get('/profile/admin/students'),
};

export const eventAPI = {
  getEvents: (): Promise<AxiosResponse<any[]>> => api.get('/event'),
  participate: (eventId: string): Promise<AxiosResponse<any>> =>
    api.post('/event/participate', { eventId }),
  createEvent: (data: CreateEventData): Promise<AxiosResponse<any>> => {
    return api.post('/event', data);
  },
  acceptEvent: (eventId: string): Promise<AxiosResponse<any>> =>
    api.post('/event/accept', { eventId }),
  getEventDetails: (eventId: string): Promise<AxiosResponse<any>> =>
    api.get(`/event/${eventId}`),
  updateEvent: (
    eventId: string,
    data: Partial<UpdateEventData>,
  ): Promise<AxiosResponse<any>> => api.put(`/event/${eventId}`, data),
  deleteEvent: (eventId: string): Promise<AxiosResponse<any>> =>
    api.delete(`/event/${eventId}`),
};

export const codingStatsAPI = {
  getStats: (): Promise<AxiosResponse<any[]>> => api.get('/coding-stats'),
  submitLeetCode: (url: string): Promise<AxiosResponse<any>> =>
    api.post('/coding-stats/leetcode', { url }),
  submitHackerRank: (
    url: string,
    manualCount: number,
  ): Promise<AxiosResponse<any>> =>
    api.post('/coding-stats/hackerrank', { url, manualCount }),
  deleteStat: (
    platform: 'LEETCODE' | 'HACKERRANK',
  ): Promise<AxiosResponse<any>> =>
    api.delete(`/coding-stats/${platform.toUpperCase()}`),
};
...
export const certificationAPI = {
  ...
  getPending: (): Promise<AxiosResponse<any[]>> =>
    api.get('/certification/pending'),
  getUserCertifications: (): Promise<AxiosResponse<any[]>> =>
    api.get('/certification/user'),
...
export const notificationAPI = {
  ...
  createNotification: (data: any): Promise<AxiosResponse<any>> =>
    api.post('/notifications', data),
  deleteNotification: (notificationId: string): Promise<AxiosResponse<any>> =>
...
export const adminAPI = {
  ...
  exportStudents: (): Promise<AxiosResponse<Blob>> =>
    api.get('/admin/export-students', { responseType: 'blob' }),
  exportLogs: (): Promise<AxiosResponse<Blob>> =>
    api.get('/admin/export-logs', { responseType: 'blob' }),
  getSystemStats: (): Promise<AxiosResponse<any>> => api.get('/admin/stats'),
  getPointRules: (): Promise<AxiosResponse<{ data: PointRule[] }>> =>
    api.get('/admin/point-rules'),
  updatePointRule: (
    key: string,
    value: number,
    description: string,
...
export const pointsAPI = {
   ...
   */
  calculateMyPoints: (): Promise<AxiosResponse<any>> =>
   ...
   */
  getMyBreakdown: (): Promise<AxiosResponse<{ data: PointBreakdown }>> =>
    api.get('/points/my-breakdown'),
  /**
  ...
  addPointsForActivity: (
    activityType: string,
    activityData?: any,
  ): Promise<AxiosResponse<{ data: ActivityPointsResult }>> =>
   ...
   */
  getPointStatistics: (): Promise<AxiosResponse<{ data: PointStatistics }>> =>
    api.get('/points/statistics'),
  /**
   ...
   */
  updateAllUserPoints: (): Promise<AxiosResponse<UpdateAllPointsResponse>> =>
    api.post('/points/update-all'),
  /**
   * Retrieves all users with their current points (admin only).
   * @returns {Promise<AxiosResponse<{ data: UserWithPoints[] }>>}
   */
  getAllUsers: (): Promise<AxiosResponse<{ data: UserWithPoints[] }>> =>
    api.get('/points/users'),
  /**
  ...
  updateUserPoints: (
    ...
    pointsToAdd: number,
    reason: string,
  ): Promise<AxiosResponse<ManualPointUpdateResponse>> =>
  ...
  resetUserPoints: (
    userIds: string[],
    reason: string,
  ): Promise<AxiosResponse<ResetPointsResponse>> =>
    api.post('/points/reset-users', { userIds, reason }),
};

export const eligibilityAPI = {
  checkEligibility: (): Promise<AxiosResponse<any>> =>
    api.get('/eligibility/check'),
  assignBatch: (
    userId: string,
    batch: string,
    auto: boolean,
  ...
  assignAllEligibleBatches: (): Promise<AxiosResponse<any>> =>
    api.post('/eligibility/assign-all-eligible'),
};
